...
function Calculator() {
  const renderButton = (text, name, color, style) => (
    <div className="flex-1 px-2 py-2 justify.cnter flex items-center text-white text-2xl font-semibold">
      <button
        type="button"
  ...
  return (
    <div className="mx-auto overflow-hidden mt-10 shadow-lg mb-2 bg-[#a4a4a4] shadow-lg border rounded-lg lg:w-2/6 mg:w-3/6 sm:w-4/6">
      <div className="">
